    ...
    <section id="solutionchallenge" className='section-spacer'>
        <div style={{display: 'flex', paddingTop: 20, paddingLeft: 70, paddingRight: 70, justifyContent: 'space-evenly', alignItems: 'center'}}>
            <div style={{flexDirection: 'column', paddingLeft: 70}}>
                ...
                <p className="section-subtitle" style={{width: 500, paddingBottom: 15, paddingTop: 15}}>The Solution Challenge is a contest held in the spring where Developer Student Clubs create innovative solutions to local community problems using Google products or platforms. We will begin creating teams and brainstorming ideas in January. Join our <a href={'https://app.slack.com/client/T01A8ENQEBV'} style={{textDecoration: 'none'}}>slack</a> to stay updated!</p>
                <a
